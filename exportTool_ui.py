...
"color: rgb(255, 255, 255);")
        ...
        self.objectNameLabel.setGeometry(QRect(550, 270, 101, 16))
        self.exportPushButton = QPushButton(self.centralwidget)
        self.exportPushButton.setObjectName(u"exportPushButton")
        self.exportPushButton.setGeometry(QRect(540, 200, 171, 51))
        font = QFont()
...
"color: rgb(255, 255, 255);")
        ...
        self.semicolonRadioButton.setGeometry(QRect(20, 40, 92, 20))
        ...
        self.otherSeparatorRadioButton.setGeometry(QRect(20, 130, 51, 20))
        ...
        self.doubleQuotationmarkRadioButton.setGeometry(QRect(20, 70, 161, 20))
        ...
        self.qualifierLineEdit.setGeometry(QRect(80, 130, 31, 22))
        self.qualifierLineEdit.setDragEnabled(False)
