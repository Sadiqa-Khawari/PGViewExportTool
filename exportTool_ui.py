...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(967, 897)
        self.centralwidget = QWidget(MainWindow)
        self.centralwidget.setObjectName(u"centralwidget")
        self.dbSettingFrame = QFrame(self.centralwidget)
        self.dbSettingFrame.setObjectName(u"dbSettingFrame")
        self.dbSettingFrame.setGeometry(QRect(30, 40, 431, 241))
        self.dbSettingFrame.setFrameShape(QFrame.Shape.StyledPanel)
        self.dbSettingFrame.setFrameShadow(QFrame.Shadow.Raised)
        self.testConnectionPushButton = QPushButton(self.dbSettingFrame)
        self.testConnectionPushButton.setObjectName(u"testConnectionPushButton")
        self.testConnectionPushButton.setGeometry(QRect(10, 200, 101, 24))
        self.testConnectionPushButton.setStyleSheet(u"background-color: rgb(85, 170, 255);\n"
"color: rgb(255, 255, 255);")
        self.widget = QWidget(self.dbSettingFrame)
        self.widget.setObjectName(u"widget")
        self.widget.setGeometry(QRect(10, 20, 401, 171))
        ...
        self.dbSettingLabel = QLabel(self.centralwidget)
        self.dbSettingLabel.setObjectName(u"dbSettingLabel")
        self.dbSettingLabel.setGeometry(QRect(30, 20, 191, 16))
        self.viewNameLineEdit = QLineEdit(self.centralwidget)
        self.viewNameLineEdit.setObjectName(u"viewNameLineEdit")
        self.viewNameLineEdit.setGeometry(QRect(30, 310, 301, 22))
        self.viewNameLabel = QLabel(self.centralwidget)
        self.viewNameLabel.setObjectName(u"viewNameLabel")
        self.viewNameLabel.setGeometry(QRect(30, 290, 111, 16))
        self.exportPushButton = QPushButton(self.centralwidget)
        self.exportPushButton.setObjectName(u"exportPushButton")
        self.exportPushButton.setGeometry(QRect(460, 310, 111, 24))
        self.exportPushButton.setStyleSheet(u"background-color: rgb(0, 170, 0);\n"
"color: rgb(255, 255, 255);")
        self.perviewTableWidget = QTableWidget(self.centralwidget)
        self.perviewTableWidget.setObjectName(u"perviewTableWidget")
        self.perviewTableWidget.setGeometry(QRect(30, 370, 841, 251))
        self.getDataPushButton = QPushButton(self.centralwidget)
        self.getDataPushButton.setObjectName(u"getDataPushButton")
        self.getDataPushButton.setGeometry(QRect(340, 310, 111, 24))
        self.getDataPushButton.setStyleSheet(u"background-color: rgb(255, 154, 12);\n"
"color: rgb(255, 255, 255);")
        self.previewLabel = QLabel(self.centralwidget)
        self.previewLabel.setObjectName(u"previewLabel")
        self.previewLabel.setGeometry(QRect(30, 350, 71, 16))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.userNameLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"K\u00e4ytt\u00e4jatunnus, oletusp\u00e4\u00e4k\u00e4ytt\u00e4j\u00e4 postgres", None))
        ...
        self.dbSettingLabel.setText(QCoreApplication.translate("MainWindow", u"Tietokantayhteyden asetukset", None))
        self.viewNameLineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"Tietokannan n\u00e4kym\u00e4n nimi, jonko tiedot vied\u00e4\u00e4n", None))
